...
public class Conversion {
    public static void main(String[] args) {
        ...
        System.out.println("변형 : "+ (int)cast2); // a는 97(외워라)
        ...
        int cast4 = 99;     // 얘는 #1로,
        int cast5 = 100;    // 얘는 #2로
        // 지시 사항 : 다운캐스팅하는 방법을 업캐스팅 방법 #1, 2를 창조하여 char 형으로 바꾼 후
        // 콘솔창에 원형과 변형을 모두 출력
...
//        char casted5 = cast5;
        ...
        /*
            ...
            되니까 기준 데이터가 변형이 일어날 가능성이 없어서 암시적(implicit)으로 변형이 가능한 반면,
            downcasting의 경우에는 데이터 용량이 축소되는 과정에서 변수가 메모리 용량을 벗어나게 되는
            경우가 있다
            (아까 강남스타일을 예시로 들었을 때 30억 넘는 숫자를 다시 int로 형변환하게 되면 마이너스값이 나오죠)
