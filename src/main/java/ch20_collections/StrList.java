...
public class StrList {
    public static void main(String[] args) {
        ...
        // 특징 element(List 내의) 검색 -> contains() 메서드 사용 리스트명.contains(목적어)
        ...
        // 시험에 pop() 메서드가 나온 적 있어서 비교해야 한다.
        // FIFP / .pop() -> 삭제 여부가 아니라 collection에서 삭제하고 삭제된 element를 return함.
