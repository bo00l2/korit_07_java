...
public class StrSet {
    public static void main(String[] args) {
        ...
        // List / Set에 element 추가하는 방법은 동일하다. 리스트or셋명.add(element);
        strList.add("java");
        strList.add("java");
        strList.add("java");
        strList.add("python");
        ...
        System.out.println(strSet);     // Set에 element들이 더해지긴 헀는데,
        // 중복이 제거되어있다. 결과값 : [TypeScript, python, java, React]
        System.out.println(strSet.size());
        System.out.println();
        // 현재 상황에서 예를 들어 set 내부에 있는 각 element들을 추출하여
        // 뒤에 " 언어"라고 붙여서 java 언어, 와 같이 데이터를 조작하는 것이
        // 불가능하다는 것을 알 수 있다.
        // 이상의 문제 등을 이유로 set -> list로의 변환 역시 자주 쓰인다.
        ...
        // set의 순서와 동일하게 들어갔기 때문에 마찬가지로 순서가 보장되지 않는다
        ...
        for(String list : modifiedStrList){
            System.out.println(list + " 언어");
        }
    }
}
// 5명의 학생이 있다고 가정하고
