package ch12_arrays;
/*
    Array06 파일 점수 배열 element의 합과 평균을 구할 수 있음
    ...
    60이상은 D
    59이하은 F 인데,
    A가 몇 명이고, B가 몇 명이고 ... 인지 출력할 수 있도록 할 예정
...
//        System.out.println("F 학생 수 : " + f);
        ...
        // 여기서 고민할 부분 -> 어차피 변수 adcdf가 하나하나 int니까
        // int[] 배열로 선언해서 선언하는 변수 개수를 줄일 수 있지 않을까
        int[] grades = { 0, 0, 0, 0, 0};
        // A에 해당하는 점수라면 grade[0] 숫자를 1+ 해주고, B에 해당하면 grade[1] + 1...
        // 굳이 다섯줄을 써가면서 변수들을 선언할 필요가 없다.
