...
//        System.out.println(name + "님의 BMI 지수는 " + bmi + " 으로 " + result + "입니다.");
    ...
    public void calcBmi(String name, double height, double weight) {
        // method 정의할 때 argument와 parameter 개념을 혼란스러워하는 경우가 있는데,
        // 정의 -> 호출이라는 순서라고 생각할 때,
        // 소괄호 내에 있는 매개변수 목록들은 자료형 + (임의의) 변수명으로 이루어져
        // 있기 때문에 '선언'이라고 간주해주면 좋겠다.
        // call1()유형에서 height를 scanner로 받았을 때, 바로 0.01을 곱해서
        // m으로 치환했었다.
        // 근데 우리는 double bmi부터 긁어왔을 때, cm 기줒ㄴ일 수도 있기 때문에
        // 추가 작업 진행
        height = height * 0.01;
...
//        // 1. Person 객체 생성
//        // 1-1 원래 객체  생성 방법
//        Person person4 = new Person("강사", 172, 68);
//        System.out.println(person4);
//        // 1-2 Builder 패턴 사용 객체 사용 방법
//        Person person5 = Person.builder()
//                .name("김오").weight(68).height(172)
//                .build();
//
//
//        bmiCalc.calcBmi(person5);

        System.out.println("------scanner 예시------");
        Scanner scanner = new Scanner(System.in);
