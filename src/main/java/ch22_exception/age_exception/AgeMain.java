...
public class AgeMain {
    ...
    public static void checkAge(int age) throws InvaildAgeException{
        if(age < 0 || age > 200){
            ...
            // 예외를 발생시킨다의 의미 -> 예외 객체를 생성시킨다는 의미
            throw new InvaildAgeException("나이는 0 ~ 200 사이의 정수만 가능합니다.");
        }
    }
...
//        int age = scanner.nextInt();         // 전에는 여기에 바로 작성해서 넣었는데,
        // 생각해보면 여기 부분에 음수값이나 200 초과점수를 집어넣을 수 있습니다.
        ...
        /*
            이상의 코드에서 정상적인 데이터 한 번 / 비정상적인 데이터 한 번 실행시켜봤을 때의
