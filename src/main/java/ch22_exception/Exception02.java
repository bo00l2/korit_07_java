...
class LoginFailedException extends Exception{
    ...
    public LoginFailedException(String message){
        super(message);         // super 클래스의 생성자 호출 
...
//            System.out.println("ID 혹은 비밀번호를 확인하세요.");
            ...
            // argument로 하는 LoginFailedException 객체가 생성되었다고 할 수 있다.
        }
    }
...
//        login(inputId, inputPassword);  // 코드 작성 순서 잘 기억하시면 좋겠습니다.
        ...
        try {
            ...
            // 그 근거는 login() 메서드 다음에 throws LoginFailedException을 작성했기 때문이다.
...
/*
    ...
    try / catch / finally 와 throws / throw 가 추가되었을 뿐이지
