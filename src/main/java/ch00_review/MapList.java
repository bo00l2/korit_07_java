...
public class MapList {
    public static void main(String[] args) {
        ...
        // 명시했어야 하나 업데이트 되면서 선언하는 부분에만 적어주면 된다.
//        List<Map<String, Object>> customers = new ArrayList<Map<String, Object>>();
        // List의 element로 Map 자료형이 들어감.
        List<Map<String, Object>> customers = new ArrayList<>();
        /*
            이상의 코드에서 Key는 String이고 Value는 Object로 되어있는 것을 확인할 수 있다.
            하지만 여러분들은 .put("name", "홍길동"); / .put("age", 30);을 넣더라도
            문제가 없었을 것이다.
            이유 -> "홍길동"은 String / 30는 Integer로 두 클래스 다 Object의 서브 클래스이기 때문
