package ch14_abstraciton.abstract_classes;
...
public class FactoryMain {
    public static void main(String[] args) {
        ...
        /*
            ...
            대체되는 경우가 많다.(근데 이게 JavaScript에도 동일하게 적용됨)

            재사용하지 않고 한 번만, 즉 이 경우에는 FactoryMain에서만 쓰고 치울 예정이면 사용하기 좋다.
        ...
        /*
            ...
            부모 클래스의 메서드를 동일하게 사용할 거라면 애초에 받아올 필요도 없이 그냥 쓰면 된다.

            다만 자식 클래스를 정의했을 때 부모 클래스에 특정 메서드가 있음을 명확하게
            알고 있어야 할 필요가 있다.

            부모 클래스에 showInfo()라는 메서드가 있는걸 몰랐다면 우리는
            PhoneFactory 클래스에 showInfo() 클래스를 따로 정의했을 테니까.
         */
