...
public class ForEachMain {
    public static void main(String[] args) {
        ...
        // 여기서 저희는 각 element를 추출하기 위해서 for문 / 향
        // 상된 for문을 사용해왔다.
        // 과일명 : 사과
        // 과일명 : 사과
        // 과일명 : 사과
        // 이상과 같은 방식으로 element를 추출하고 가공하기 위해서는 필수적이었다고 할 수 있다.
        // 1. 일반 for문
        ...
        // 이상의 '메서드 내 람다식 작용' 방식은 js에서도, 그리고 Java를 이용하는 springboot 내부에서도
        // 자주 사용할 예정이니 익숙해지면 유용하게 쓸 수 있습니다.
    }
}
