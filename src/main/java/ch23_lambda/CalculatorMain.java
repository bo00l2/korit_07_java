...
public class CalculatorMain {
    ...
    public static void main(String[] args) {
        ...
        // 저희는 여기서 추가 조작을 통해서 사칙연산을 시도할겁니다.
        ...
        System.out.println("--- static method 호출 방식 ---");
        System.out.println("2 + 3 = " + operate(2, 3, add));    // static method 의 로직을 조면
        // 세번째 매개변수로 Calculator 인터페이스의 서브 클래스를 받습니다.
        // 그리고 return 문을 보면 해당 객체의 .calculate() 메서드를 호출하는 것을 확인할 수 있습니다.
